...
#  ifdef CONFIG_ARCH_CHIP_STM32G474R
   /* STM32G4 uses APB1ENR/RSTR1 not APB1LENR/LRSTR */
#   define TIMX_RCC_ENR_MASK      UAVCAN_STM32H7_GLUE3(RCC_APB1ENR1_TIM,  UAVCAN_STM32H7_TIMER_NUMBER, EN)
#   define TIMX_RCC_RSTR_MASK     UAVCAN_STM32H7_GLUE3(RCC_APB1RSTR1_TIM, UAVCAN_STM32H7_TIMER_NUMBER, RST)
#  else
   /* STM32H7 uses APB1LENR/LRSTR */
...
#  ifdef CONFIG_ARCH_CHIP_STM32G474R
	/* STM32G4 uses APB1RSTR1 not APB1RSTR */
	modifyreg32(STM32_RCC_APB1RSTR1, 0, TIMX_RCC_RSTR_MASK);
	modifyreg32(STM32_RCC_APB1RSTR1, TIMX_RCC_RSTR_MASK, 0);
#  else
	/* STM32H7 uses APB1RSTR */
